...
int main( int argc, char** argv )
{
	...
	Camera cap1 = Camera(cs, &cap);
	cv::Mat image = cap1.getGray(ROWS, COLS);
	...
	cout << "Generated random numbers for: " << total_dendrites << " dendrites" << endl;
